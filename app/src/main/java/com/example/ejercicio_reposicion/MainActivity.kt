package com.example.ejercicio_reposicion
...
class MainActivity : AppCompatActivity() {
    ...
    private fun getApiResult() {
        if (et_firstConversion != null && et_firstConversion.text.isNotEmpty() && et_firstConversion.text.isNotBlank()) {
            ...
            var API ="https://cdn.jsdelivr.net/gh/fawazahmed0/currency-api@1/latest/currencies/$baseCurrency/$convertedToCurrency.json"
